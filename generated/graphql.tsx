...
export type TasksProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<TasksQuery, TasksQueryVariables>
    } & TChildProps;
export function withTasks<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  TasksQuery,
  TasksQueryVariables,
  TasksProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, TasksQuery, TasksQueryVariables, TasksProps<TChildProps, TDataName>>(TasksDocument, {
      alias: 'tasks',
      ...operationOptions
    });
};
